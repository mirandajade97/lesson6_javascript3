...
function previewFive() {
   ...
   // add appropiate src values to two new img elements 
...
/*******************************************************************************************************/
// create event listeners for left arrow, right arrow, and five button elements
function createEventListeners() {
 ...
 //the leftArrow() funtion will be executed when the user clicks the left navigation arrow button
 ...
 //the rightArrow() funtion will be executed when the user clicks the right navigation arrow button
